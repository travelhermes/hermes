/*! remarkable 1.6.0 https://github.com/jonschlinkert/remarkable @license MIT */ (function (f) {
    ...
    })(
        {
            ...
            3: [
                function (require, module, exports) {
                    ...
                    var attr_value = replace(/(?:unquoted|single_quoted|double_quoted)/)('unquoted', unquoted)(
                        'single_quoted',
                        single_quoted
                    )('double_quoted', double_quoted)();

                    var attribute = replace(/(?:\s+attr_name(?:\s*=\s*attr_value)?)/)('attr_name', attr_name)(
                        'attr_value',
                        attr_value
                    )();
                    ...
                    var HTML_TAG_RE = replace(/^(?:open_tag|close_tag|comment|processing|declaration|cdata)/)(
                        'open_tag',
                        open_tag
                    )('close_tag', close_tag)('comment', comment)('processing', processing)('declaration', declaration)(
                        'cdata',
                        cdata
                    )();
                ...
                function (require, module, exports) {
                    ...
                    rules.image = function (tokens, idx, options /*, env */) {
                        ...
                        var title = tokens[idx].title
                            ...
                            : '';
                        var alt =
                            ' alt="' + (tokens[idx].alt ? escapeHtml(replaceEntities(tokens[idx].alt)) : '') + '"';
            ...
            33: [
                function (require, module, exports) {
                    ...
                    module.exports = function table(state, startLine, endLine, silent) {
                        var ch, lineText, pos, i, nextLine, rows, aligns, t, tableLines, tbodyLines;
                    ...
                    (function (root, factory) {
                        ...
                        Autolinker.AnchorTagBuilder = Autolinker.Util.extend(Object, {
                            ...
                            createCssClass: function (matchType) {
                                ...
                                if (!className) return '';
                                else return className + ' ' + className + '-' + matchType; // ex: "myLink myLink-url", "myLink myLink-email", or "myLink myLink-twitter"
                            },
                        ...
                        Autolinker.matchParser.MatchParser = Autolinker.Util.extend(Object, {
                            ...
                            replace: function (text, replaceFn, contextObj) {
                                ...
                                return text.replace(
                                    this.matcherRegex,
                                    function (matchStr, $1, $2, $3, $4, $5, $6, $7, $8) {
                            ...
                            processCandidateMatch: function (
                                ...
                                if (emailAddressMatch) {
                                    ...
                                    if (protocolRelativeMatch) {
                                        var charBeforeMatch =
                                            protocolRelativeMatch.match(this.charBeforeProtocolRelMatchRegex)[1] || '';
