...
!(function (t, i) {
    ...
    var qi = {
        ...
        Ki = E.extend({
            ...
            _findEventTargets: function (t, i) {
                for (
                    var e, n = [], o = 'mouseout' === i || 'mouseover' === i, s = t.target || t.srcElement, r = !1;
                    s;
        ...
        _project: function () {
            ...
            c.distance === F.distance
                ? ((t = Math.PI / 180),
                  ...
                  (r =
                      Math.acos(
                          (Math.cos(i * t) - Math.sin(u * t) * Math.sin(s * t)) / (Math.cos(u * t) * Math.cos(s * t))
                      ) / t),
        ...
        getCenter: function () {
            ...
            for (n = t = 0; t < h - 1; t++)
                if (((o = a[t]), (s = a[t + 1]), i < (n += e = o.distanceTo(s))))
                    return (
                        (r = (n - i) / e), this._map.layerPointToLatLng([s.x - r * (s.x - o.x), s.y - r * (s.y - o.y)])
                    );
        },
        getBounds: function () {
            return this._bounds;
    ...
    var hn = Me.extend({
            ...
            onAdd: function () {
                this._container ||
                    (this._initContainer(), this._zoomAnimated && ci(this._container, 'leaflet-zoom-animated')),
                    this.getPane().appendChild(this._container),
                    this._update(),
